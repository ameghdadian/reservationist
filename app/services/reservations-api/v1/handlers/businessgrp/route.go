...
func Routes(app *web.App, cfg Config) {
	...
	app.Handle(http.MethodPut, version, "/businesses/{business_id}", hdl.Update, authen, tran)
	app.Handle(http.MethodDelete, version, "/businesses/{business_id}", hdl.Delete, authen, tran)
}
