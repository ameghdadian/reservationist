...
var (
	// OK indicates the opeartion was successful.
	OK = ErrCode{0}
	...
	// AlreadyExists mean an attempt to create an entity failed because one
	// already exists.
	...
	// operation is applied to a non-direction, etc.
